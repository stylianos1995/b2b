...
export class BusinessController {
  ...
  @Post()
  async create(@CurrentUser() user: RequestContext, @Body() dto: CreateBusinessDto) {
  ...
  @UseGuards(RolesGuard)
  @Roles('business_owner', 'business_manager', 'business_staff')
  async getLocations(@CurrentUser() user: RequestContext, @Param('id', ParseUUIDPipe) id: string) {
